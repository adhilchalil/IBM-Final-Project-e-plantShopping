    ...
    return (
        <div>
            ...
            <div className="tag">
               ...
               <a href="/IBM-Final-Project-e-plantShopping" style={{textDecoration:'none'}}>
                        <div>
            ...
            <div style={styleObjUl}>
                ...
                <div>
                    <a href="#" style={{...styleA, position: 'relative', left: "0px"}} onClick={(e) => handleCartClick(e)}>
                        <h5 className='cart_quantity_count'>{totalItemCount}</h5>
                        <h1 className='cart'>
        ...
        <div className="product-grid">
                {plantsArray.map((category, index) => (
                    <div key={index}>
                        <div style={{display: "flex",justifyContent: "center"}}><h1 className='plant_heading'>{category.category}</h1></div>
